    ...
    <div className="flex w-full flex-col items-center overflow-x-hidden">
      ...
      <section className="w-full py-16">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg prose-gray max-w-none prose-headings:text-gray-900 prose-h1:hidden prose-h2:mt-10 prose-h2:border-b prose-h2:border-gray-200 prose-h2:pb-2 prose-h3:text-xl prose-p:leading-relaxed prose-li:marker:text-blue-600 prose-strong:text-gray-900 prose-table:text-sm prose-th:bg-gray-50 prose-th:p-3 prose-td:p-3">
